...
name_file_yaml = 'topology.yaml'

def transform_topology(name_file_yaml):
    list_yaml = []
    dict_yaml = {}
    with open(name_file_yaml, 'r') as f:
        templet = yaml.safe_load(f)
        for i in list(templet):
...
if __name__ == '__main__':
    d_y = transform_topology(name_file_yaml)
    pprint(d_y)
    draw_topology(d_y)
